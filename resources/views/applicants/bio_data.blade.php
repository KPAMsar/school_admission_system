...
if ($applicant->getBioData != null) {
    $address_1 = $applicant->getBioData->address_1;
    $city_1 = $applicant->getBioData->city_1;
    $address_2 = $applicant->getBioData->address_2;
    $city_2 = $applicant->getBioData->city_2;
    $country_of_residence = $applicant->getBioData->country_residence;
    $state_of_residence = $applicant->getBioData->state_residence;
    $lga_of_residence = $applicant->getBioData->lga_residence;
    $country_of_origin = $applicant->getBioData->country_origin;
    $state_of_origin = $applicant->getBioData->state_origin;
    $lga_of_origin = $applicant->getBioData->lga_origin;
    $dob_day = explode('-', $applicant->getBioData->dob)[2];
    $dob_month = explode('-', $applicant->getBioData->dob)[1];
    $dob_year = explode('-', $applicant->getBioData->dob)[0];
    $nok_first_name = $applicant->getBioData->nok_first_name;
    $nok_last_name = $applicant->getBioData->nok_last_name;
    $nok_address = $applicant->getBioData->nok_address;
    $nok_city = $applicant->getBioData->nok_city;
    $nok_country_of_residence = $applicant->getBioData->nok_country;
    $nok_state_of_residence = $applicant->getBioData->nok_state;
    $nok_lga_of_residence = $applicant->getBioData->nok_lga;
    $nok_phone_number = $applicant->getBioData->nok_phone;
    $nok_email = $applicant->getBioData->nok_email;
}else{
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control show-tick" name="state_of_residence" onchange="getResidtLGA(value)">
                                            ...
                                            <option  {{$state_of_residence == $state ? 'selected' : ''}} value="{{$state}}" selected>{{$state}}</option>
